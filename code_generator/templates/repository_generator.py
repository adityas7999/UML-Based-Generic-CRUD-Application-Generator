        ...
        ordered_attributes = [
            {
                ...
                "db_type": _map_python_to_sql_type(attribute.get("type", "").strip()),
            }
...
def _map_python_to_sql_type(python_type: str) -> str:
    """
    Map Python/UML types to SQL types for column definitions.
    Safe approach: most will be VARCHAR/INT.
    """
    type_map = {
        "string": "VARCHAR(255)",
        "integer": "INT",
